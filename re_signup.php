...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/re_signup.css">
    <script src="js/re_signup.js"></script>
</head>
<body>
    <div class="container">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
            <form name="myForm" onsubmit="return(verify())" action="Ret_Register.php" method="post">
                ...
                <hr class="colorgraph">
                <div class="row">
                    <div class="col-xs-12 col-md-6"><input type="submit" name="Register" value="Register" class="btn btn-primary btn-block btn-lg" tabindex="11"></div>
                    <div class="col-xs-12 col-md-6"><a href="re_login.html" class="btn btn-success btn-block btn-lg">Sign In</a></div>
                </div>
            </form>
        </div>
    </div>
